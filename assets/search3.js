...
$(document).ready(function() {
  ...
  function auto_come(data){
                ...
                if(arg.name.replace(/ /g, '').indexOf(txt) > -1 || arg.jp.replace(/ /g, '').indexOf(txt) > -1){
                  if(arg.name.replace(/ /g, '').indexOf(txt) > -1){
                    ...
                    $('#autoMaker').append(
                        ...
                        $('<div>').html("<a href='https://whenessel.github.io/"+lang+"/alchemist/?item="+arg.name+"'><img class=\"thumb\" src=\"https://wstatic-cdn.plaync.com/powerbook/l2m/icon/Icon_128/Item/Icon_"+arg.icon+".png\" onerror=\"this.src='https://wstatic-cdn.plaync.com/plaync/gameinfo/img/thumb-lineage2m.png';\">"+item_name+"</a>").attr({'recipe':arg.recipe})
                    );
                }
            });
    ...
    window.localStorage.clear();
		$.getJSON("https://whenessel.github.io/alchemist/item2.json?version=20220809", function(data) {
